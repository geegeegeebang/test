...
export function getCdInfo(){
  let url = "http://musicapi.taihe.com/v1/restserver/ting?from=webapp_music&format=json&param=kle2UgL%2B1qbDe%2BW%2BeRX1%2Bw%3D%3D&timestamp=1553477966&sign=b9946df2dba0ec6d8bc76a5fd846f725&method=baidu.ting.recommend.getRecDiyList";
...
export function getSingerList(){
  let url = 'https://c.y.qq.com/v8/fcg-bin/v8.fcg?channel=singer&page=list&key=all_all_all&pagesize=1000&pagenum=1&g_tk=5381&loginUin=0&hostUin=0&format=jsonp&inCharset=utf8&outCharset=utf-8&notice=0&platform=yqq&needNewCode=0';
